...
For a GitHub portfolio, this project is useful because it shows more than basic syntax. It demonstrates design decisions, problem solving, debugging, simulation behavior, and user interface work in a single repository.
